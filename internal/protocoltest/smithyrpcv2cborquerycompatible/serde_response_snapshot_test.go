...
func TestSerdeCheckResponseSnapshot_GetItem(t *testing.T) {
	want := &GetItemOutput{}
	status, header, body, err := serdeRespReadSnapshot("GetItem")
	...
	if err := smithytesting.CompareValues(want, got); err != nil {
		t.Errorf("response snapshot mismatch for %s: %v", "GetItem", err)
	}
}
