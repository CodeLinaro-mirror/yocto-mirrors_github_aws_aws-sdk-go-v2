...
//
// The wrapper is installed at Transport.DialContext, beneath TLS, so it
// behaves identically on HTTP/1.1 and HTTP/2.
...
// installReadTimeout wraps the transport's dialer so every connection it opens
// carries this client's read timeout.
