...
func (c *Client) addOperationCancelCapacityReservationMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "CancelCapacityReservation", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
