...
func (c *Client) addOperationDescribeVolumesModificationsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = stack.Initialize.Add(newServiceMetadataMiddleware(options.Region, "DescribeVolumesModifications", options.EndpointResolver != nil), middleware.Before); err != nil {
		return err
	}
