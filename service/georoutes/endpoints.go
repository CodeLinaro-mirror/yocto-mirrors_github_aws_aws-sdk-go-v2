...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/georoutes/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_GEO_ROUTES")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Geo Routes", cfg.ConfigSources)
	if found && err == nil {
