...
import (
	...
	internalendpoints "github.com/aws/aws-sdk-go-v2/service/billingconductor/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_BILLINGCONDUCTOR")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "billingconductor", cfg.ConfigSources)
	if found && err == nil {
		...
		if exprVal := awsrulesfn.GetPartition(_Region); exprVal != nil {
			...
			if _PartitionResult.Name == "aws" {
				if _UseFIPS == false {
					if _UseDualStack == false {
						uriString := "https://billingconductor.us-east-1.amazonaws.com"
								...
								smithyauth.SetAuthOptions(&out, []*smithyauth.Option{
									{
										...
										SignerProperties: func() smithy.Properties {
											...
											smithyhttp.SetSigV4SigningName(&sp, "billingconductor")
											smithyhttp.SetSigV4ASigningName(&sp, "billingconductor")
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://billingconductor-fips.")
			...
			if _UseDualStack == true {
				if true == _PartitionResult.SupportsDualStack {
					uriString := func() string {
						var out strings.Builder
						out.WriteString("https://billingconductor.")
						out.WriteString(_Region)
						out.WriteString(".")
						out.WriteString(_PartitionResult.DualStackDnsSuffix)
						return out.String()
