...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "SageMaker Runtime", cfg.ConfigSources)
	if found && err == nil {
					...
					if true == _PartitionResult.SupportsFIPS {
						if true == _PartitionResult.SupportsDualStack {
							uriString := func() string {
								...
								out.WriteString("https://runtime.sagemaker-fips.")
			...
			if _UseFIPS == true {
				if _PartitionResult.SupportsFIPS == true {
					if _PartitionResult.Name == "aws" {
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://runtime-fips.sagemaker.")
							out.WriteString(_Region)
					...
					if _PartitionResult.Name == "aws-us-gov" {
						uriString := func() string {
							var out strings.Builder
							out.WriteString("https://runtime.sagemaker.")
							out.WriteString(_Region)
							out.WriteString(".amazonaws.com")
							return out.String()
						}()
